            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-6">
                            <h1 id="CustomerActionLabel" runat="server">Add customer</h1>
                            ...
                            <div class="form-group">
                                <asp:Button ID="AddButton" class="btn btn-primary btn-md" runat="server" Text="Add" OnClick="AddButton_Click" Visible="true" />
                                <asp:Button ID="UpdateButton" class="btn btn-warning btn-md" runat="server" Text="Update" OnClick="UpdateButton_Click" Visible="false" />
                                <asp:Button ID="DeleteButton" class="btn btn-danger btn-md" runat="server" Text="Delete" OnClick="DeleteButton_Click" Visible="false" />
                            </div>
                        </div>
                    </div>
                </div>
